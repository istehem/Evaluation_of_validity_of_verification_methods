...
purpose is however to evaluate if Quviq QuickCheck can be used to fulfil this.
...
We will not implement deprecated functions in our model, nor will we implement
support functions from the c-code.