...
==============================================================================
\end{comment}
This standard is built on top of another industrial standard IEC 61508 named
``XXX'' which purpose was to ensure functional safety in industries. Hazards in
the industry is given certain safety integrity levels called SILs, depending on
how dangerous, what consequences and how probable they are. There are four
different SILs ranged from 1-4, where 4 is the most dangerous classification. To
ensure safety, SILs with classification 4 are tested and documented the most.
An example for hazards with SIL 4 is a nuclear power plant XXX. This has
classification 4 because it would mean considerable damage to a whole society.
Because of these damages is not probable to happened in the automotive industry,
SIL 1-4 are replaced with ASIL A-D, automotive safety integrity levels.
The highest ASIL, D, corresponds with SIL 3.
\begin{comment}
==============================================================================
SLUT NYSKRIVEN TEXT!
==============================================================================
