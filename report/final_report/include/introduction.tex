...
late 2011 (k\"{a}lla: www.iso.org/iso/search.htm?qt=ISO+26262\&published=on)
ISO 26262 named ``Road vehicles -- Functional safety'' is a general standard on
how the development of vehicles should be made from scratch to finish.)
