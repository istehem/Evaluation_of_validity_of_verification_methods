...
\subsection{C-code}
Bullseye Coverage was to analyse the coverage of the C-code. The results show
that the decision coverage is over ?? and all functions except for one is
executed, see figure \ref{FIG:BULLSEYE}. The reason for that there are a missing
function call is that it is deprecated. 
