...
bound, then there is a risk that rules for deadline or logical
...
between two checkpoints. These graphs are defined by the logical
...
support function to that function. One of our limitations was to not
...
much about the whole system's state space since it is very large, due
