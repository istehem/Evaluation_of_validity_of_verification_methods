...
and is called just before a call to the C-code is performed. Note that
...
state if the main function or the checkpointreached function are about to be
called in the C-code. The remaining measured module \emph{wdgm\_post} checks
