...
% requirements.
It is therefor hard to analyze code that is written without the standard in
...
available, there are also verification in which the hardware should be taken into
...
% consideration.
This is beyond the scope of this thesis.% This is beyond the scope of this thesis and can also not be
