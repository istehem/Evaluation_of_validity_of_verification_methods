...
manager. Hence there may be needed a lot of calculations needed to find test
cases that are actual valid so that the absorbing state is not reached. The
complexity of finding such cases grows with the complexity of the configuration.
