...
%% Mimicking an API-function to circumvent bugs in the actual code.
\newacronym{Mock}{Mocking}{Mocking allows testing of code units without being reliant on dependencies.}
