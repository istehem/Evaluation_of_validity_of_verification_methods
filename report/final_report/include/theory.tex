...
\begin{figure}
  \begin{center}
    \includegraphics{pictures/autosar_architecture.jpg}
  \end{center}
  \label{FIG:AUTOSAR:architecture}
  \caption{The AUTOSAR software architecture}
\end{figure}

The runtime environment is the OS, and the microcontroller is the hardware. The
software running in the application layer could be applications such as sensors
and actuators.
...
\begin{figure}
  ...
  \caption{The Watchdog architecture}
\end{figure}
