...
are very precise. Describing a system in a formal manner gives rise to the
ability of automating test cases for the system since it is precisely defined.
It is however possible to use formal methods even when the system is informally
defined ...
