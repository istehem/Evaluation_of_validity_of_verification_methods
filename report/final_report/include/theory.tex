...
%% SKRIV OM V-modellen i ISO~26262
%% Och integrationstester mot unittester etc, (6-9, 6-10, 6-11 i ISO)
...
implementation''. %%%% FORTSÄTT HÄR!!

\begin{figure}
  \includegraphics[keepaspectratio, width=\linewidth]{V}
...
%% SKRIV OM introduktionen av functional safety i version 4 av AUTOSAR
