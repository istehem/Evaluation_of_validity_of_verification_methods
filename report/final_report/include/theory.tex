...
program. This because of the property based testing only validates the
...
properties that must hold for the program. QuickCheck provides guided
random test generation. This means that the samples can be weighted to
cover certain parts of the state space with more likelihood.
