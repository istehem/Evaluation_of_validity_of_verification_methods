...
appendix \ref{APP:SEC:OTHERMODULES}. Then there is two equally good
...
Although the C-code was used actively in lab environments, bugs were found early
in the process.
...
source code is available. However, this make the ambiguities harder to
...
that were executed after that, was not able to change the state of the WdgM.
