...
general behavior. This status can be assigned 5 different values and
can be described as a state machine. The global status was considered
very important, since it specifies correct and incorrect behaviour of
