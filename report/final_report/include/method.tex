...
Parasoft C/C++test is an integrated development testing solution for C
and C++ \cite{PARASOFT:datasheet}. It has automated code analysis,
which enforces code policies depending on given rules.
It also detects certain runtime errors such as referencing null
pointers, buffer overflows, division by zero and using uninitialized
memory/variables.

Parasoft C/C++test is a commercial tool with a huge range of functionality,
...
requirements using their methods(?).
