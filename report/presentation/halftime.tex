...
\begin{frame}[fragile]
  ...
  \begin{block}{Getters}
    \begin{itemize}
      \item \lstinline!WdgM_GetVersionInfo!
      \item \lstinline!WdgM_GetMode!
      \item \lstinline!WdgM_GetLocalStatus!
      \item \lstinline!WdgM_GetGlobalStatus!
      \item \lstinline!WdgM_GetFirstExpiredSEID!
    \end{itemize}
  \end{block}

  \begin{block}{Setters}
    \begin{itemize}
      \item \lstinline!WdgM_Init!
      \item \lstinline!WdgM_DeInit!
      \item \lstinline!WdgM_PerformReset!
      \item \lstinline!WdgM_SetMode!
      \item \lstinline!WdgM_MainFunction!
      \item \lstinline!WdgM_Checkpointreached!
    \end{itemize}
  \end{block}
\end{frame}
%================================================
