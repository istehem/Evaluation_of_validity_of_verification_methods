...
arguing that the state space that is not checked will not affect the model. It
is not possible to do in a complex computer system due to the state space
problem. The ISO-standard mentions both ``formal verification'' and ``semi
